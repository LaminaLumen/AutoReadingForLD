...
根目录的 `AutoReadingForLD.user.js` 是唯一发布文件。GitHub `main` 分支用于稳定版本，用户脚本元数据中的下载与更新地址均指向该文件。

## GitHub Raw

稳定安装地址：

<https://raw.githubusercontent.com/LaminaLumen/AutoReadingForLD/main/AutoReadingForLD.user.js>
...
2. 粘贴 `AutoReadingForLD.user.js` 的完整内容。
...
2. 上传或粘贴 `AutoReadingForLD.user.js`。
3. 填写项目主页和问题反馈地址。
